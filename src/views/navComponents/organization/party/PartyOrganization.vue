<!-- 
 ...
 -->
<template>
  <div class="party-organization block-wrap" ref="contentWrap">
    <!-- header -->
    ...
    <div class="block-content">
      <div class="block-title">我的党组织结构</div>
...
<script>
  export default {
  	data(){
        ...
        partyOrgId:sessionStorage.getItem('userData')?JSON.parse(sessionStorage.getItem('userData')).partyOrgId:null,
        patryTree:[],
        defaultProps: {
          children: 'childrens',
          label: 'name'
      ...
      getParty(){
        this.isLoading = true;
        this.axios.get(`${this.common.basePath}/party_orgs/top/single/tree`,{params:{id:this.partyOrgId}}).then( (response) => {
          this.patryTree.push(response.data.data);
      ...
      handleNodeClick(data,node,nodeCompent){
        this.$router.push({name:'partyDetail',params:{id:data.id}});
      },
